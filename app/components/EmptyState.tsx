...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col flex-1 h-full items-center justify-center pb-10 rounded-md border border-dashed p-8 text-center animate-in fade-in-50">
