...
export default function Features(){
    return (
        <section className="py-8">
            ...
            <h2 className="text-6xl text-white/95 font-medium text-center mt-6">Where power meets {""} 
            ...
            <div className="mt-8 flex flex-wrap gap-3 justify-center">
                {features.map((feature) => (
                    <div key={feature} className="bg-neutral-900 gap-3 text-white/95 items-center border border-white/10 inline-flex px-3 py-1.5 rounded-2xl">
                        <span className="bg-rose-500 text-white/95 size-5 text-xl rounded-full inline-flex items-center justify-center">&#10038;</span>
